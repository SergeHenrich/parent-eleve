...
export const gradesAPI = {
  getByStudent: (studentId, params = {}) => api.get(`/grades/eleve/${studentId}`, { params }),
  getGrades: (studentId, params = {}) => api.get(`/grades/eleve/${studentId}`, { params }),
  getAverages: (studentId, params = {}) => api.get(`/grades/eleve/${studentId}/moyennes`, { params }),
  getBulletin: (studentId, trimestre) => api.get(`/grades/eleve/${studentId}/bulletin/${trimestre}`),
  getSubjects: () => api.get('/grades/matieres'),
}

// Services pour les absences
export const absencesAPI = {
  getByStudent: (studentId, params = {}) => api.get(`/absences/eleve/${studentId}`, { params }),
  getAbsences: (studentId, params = {}) => api.get(`/absences/eleve/${studentId}`, { params }),
  getById: (absenceId) => api.get(`/absences/${absenceId}`),
  getStatistics: (studentId, params = {}) => api.get(`/absences/eleve/${studentId}/statistiques`, { params }),
  getMonthlyReport: (studentId, year, month) => api.get(`/absences/eleve/${studentId}/recapitulatif/${year}/${month}`),
  justify: (absenceId, data) => api.put(`/absences/${absenceId}/justifier`, data),
}
...
export const notificationsAPI = {
  ...
  markAsRead: (notificationId) => api.put(`/notifications/${notificationId}/marquer-lue`),
